...
namespace Classes___Exercise_1___v2
{
    ...
    {
        internal static void StartMethod(DateTime startTime)
        {
            startTime = DateTime.Now;
        }
        internal static void StopMethod(DateTime stopTime)
        {
            stopTime = DateTime.Now;
        }

        internal void Duration(TimeSpan duration)
        {
